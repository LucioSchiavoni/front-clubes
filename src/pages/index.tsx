  ...
  return (
    <div className="flex min-h-[100dvh] flex-col">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-center bg-club-green [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)] dark:bg-black"></div>
        <section className="flex flex-col items-center justify-center w-full">
          <div className="max-w-xl w-full flex flex-col items-center justify-center text-center relative px-4 md:px-6">
            ...
            >
              <Badge className="rounded-full px-4 mt-4 py-1.5 text-sm font-medium" variant="secondary">
                Proximamente
              </Badge>
        ...
        Gestiona tu club
              ...
              <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
                Administra los productos, reservas, socios de tu club de una forma organizada tanto para ti como para tus socios.
              </p>
      ...
      <footer className="w-full border-t bg-background/95 backdrop-blur-sm">
        <div className=" flex flex-col items-center justify-center gap-8 px-4 py-10 md:px-6 lg:py-16">
